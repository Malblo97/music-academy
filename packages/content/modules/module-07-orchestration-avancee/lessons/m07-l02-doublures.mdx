...
|---|---|---|
| **L'unisson** | même ligne, même octave | la FUSION : les timbres s'épousent en un alliage — le troisième timbre pur (violons+hautbois : le chant focalisé, m05-l10 ; celli+cors : LA doublure signature, §5.2/l04) |
| **L'octave** | même ligne, ±12 | l'ÉLARGISSEMENT : la ligne gagne de l'espace vertical sans gagner d'épaisseur locale — le thème qui devient panoramique (violons+celli 8va : le lyrisme de film, m05-l04 ; +flûte 8va sup : la lumière ajoutée, m05-l07) |
...
La loi d'alliage de l'unisson, à connaître par cœur : **le timbre le plus caractérisé domine l'alliage** — hautbois+clarinette sonne hautbois adouci (le focalisant gagne, m05-l10/l12) ; cordes+bois sonne cordes éclairées (la masse gagne) ; et les `avoidWith` des fiches (cor+trompette ff) sont des alliages où l'un *avale* l'autre : la table §25.1 est ta table de chimie.
...
| Altos + clarinette | unisson | le velours | la douceur voilée (m05-l03/l12) |
...
| Piccolo + tout tutti | 8va sup | le sommet perçant | l'éclat final (m05-l07 : jamais discret) |
